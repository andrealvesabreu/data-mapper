...
/**
 * This is a reverse version of csv_assoc.csv, just to show reordered columns in conversion
 */
...
return [
    ...
    'setup' => [
        ...
        'length' => 1000, //maxlenght of each size
        'maxItems' => 150, //maximum number of elements in a line
        'maxRecords' => 15000, //Maximum number of records
        'header' => true, //Indicates thet file has a line header
